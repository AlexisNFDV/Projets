...
<section id="transp">
	<h1>Besoin d'informations sur votre destination ?</h1>
	<p>Sélectionnez un pays et retrouvez ici toutes les informations nécessaires au bon déroulement de votre voyage</p>
	<div class="ui fluid search selection dropdown">
	<input type="hidden" name="country" id="pays">
...
<div id="map" style="width: 100%; height: 481px; opacity: 0"></div>
<i id="back" class="fa fa-chevron-circle-left fa-5x" style="top: 55px; right: 0; position: absolute; margin: 10px; color: white; opacity: 0;">
</i>
	...
	<div class="scrolling image content">
		...
		<div class="description">
			...
			<div id="first">
				...
				<h3>Pièces d'identités :</h3> 
				<span>
					En cours de validité.
				</span><br>
				<h3>Visa : </h3>
				<span>
					Les ressortissants des pays suivant sont autorisés à entrer en Thaïlande sans visa pour un séjour touristique de moins de 30 jours :<br>
			...
			<div id="two">
				<h3>Médicaments :</h3>
				<span>
					Les personnes qui justifient d’un traitement médical en cours doivent s’assurer auprès de l’ambassade de Thaïlande que les médicaments emportés sont autorisés.
				</span><br>
				<h3>Système de santé :</h3> 
				<span>
					Le système de santé thaïlandais est de bonne qualité, vous trouverez des médecins qui parlent l’anglais dans la plupart des hôpitaux.<br>
					Vous trouverez aussi un grand nombre de pharmacie et pratiquement les mêmes médicaments (même qualité) que dans les pays occidentaux.<br>
				...
				<h3>Vaccins :</h3>
				<span>
					La mise à jour de la vaccination diphtérie-tétanos-poliomyélite est conseillée. <br>
					Autres vaccinations conseillées (selon conditions d’hygiène et durée du séjour) : fièvre typhoïde, hépatites virales A et B. <br>
					Autres vaccinations : en cas de séjour en zone rurale, la vaccination contre l’encéphalite japonaise peut être nécessaire. <br>
				</span><br>
				<h3>Maladies :</h3>
				<span>
					<li>Syndrome Pied-Main-Bouche</li>
					<li>Choléra</li>
					<li>Paludisme (malaria)</li>
					<li>Dengue</li>
					<li>Encéphalite japonaise </li>
					<li>Grippe (H1N1, aviaire)</li>
					<li>Infection par le virus HIV</li>
					<li>Les maladies sexuellement transmissibles (MST)</li>
				</span>
			</div>
			<div id='third'>
				<p>A voir</p>
...
<?php
include('Includes/footerPays.php')
?>