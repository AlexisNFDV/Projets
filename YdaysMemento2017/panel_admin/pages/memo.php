...
$get_memo = $dbh->query('SELECT * FROM memo WHERE is_validate = 0');
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="text-right">
									...
									<a class="btn btn-success" href="accept_memo.php?id=<?= $value['id']?>" role="button"><i class="fa fa-check" aria-hidden="true"></i></a>
								</div>
							</div>
