...
/*email sending when sign up
      ...
      $message ='<html><body>';
      $message .='<img src="assets/icons/logo_devento.png" width="200px" alt="Confirmation" />';
      ...
      $message .="<a href=\"http://localhost/Traiteur/login.php\">Connexion</a>";
      $message .='</body></html>';
